...
config_options.osdmenu_cnf_categories = {
  {
    options = {
      ...
      { key = "OSDSYS_Skip_Logo",     optType = "bool", default = "0" },
  ...
  },
  {
    options = {
      ...
      { key = "OSDSYS_menu_x",                optType = "int",   default = "430" },
      { key = "OSDSYS_menu_y",                optType = "int",   default = "110" },
      { key = "OSDSYS_enter_x",               optType = "int",   default = "-1" },
  ...
  {
    options = {
      { key = "cdrom_skip_ps2logo",   optType = "bool", default = "0" },
...
config_options.osdmbr_cnf = {
  ...
  { key = "ps1drv_enable_fast",   optType = "bool",      default = "0" },
  { key = "ps1drv_enable_smooth", optType = "bool",      default = "0" },
  { key = "ps1drv_use_ps1vn",     optType = "bool",      default = "0" },
